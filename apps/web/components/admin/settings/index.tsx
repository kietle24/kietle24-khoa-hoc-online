...
const Settings = (props: SettingsProps) => {
            ...
            const fetchRequest = fetch
                .setPayload({
                    ...
                    variables: {
                        ...
                        payosClientId: newSettings.payosClientId,
                        payosApiKey: newSettings.payosApiKey,
                        payosChecksumKey: newSettings.payosChecksumKey,
                    },
                })
                .build();
            const response = await fetchRequest.exec();
    ...
    const getPaymentSettings = (getNewSettings = false) => ({
        ...
        payosClientId: getNewSettings
            ? newSettings.payosClientId
            : settings.payosClientId,
        payosApiKey: getNewSettings
            ? newSettings.payosApiKey
            : settings.payosApiKey,
        payosChecksumKey: getNewSettings
            ? newSettings.payosChecksumKey
            : settings.payosChecksumKey,
    });
            ...
            >
                ...
                <div>
                    ...
                    >
                        ...
                        {newSettings.paymentMethod === PAYMENT_METHOD_PAYOS && (
                            <>
                                <FormField
                                    label="PayOS Client ID"
                                    name="payosClientId"
                                    value={newSettings.payosClientId || ""}
                                    onChange={onChangeData}
                                />
                                <FormField
                                    label="PayOS API Key"
                                ...
                                <FormField
                                    ...
                                    type="password"
                                    value={newSettings.payosChecksumKey || ""}
                                    onChange={onChangeData}
                                    autoComplete="off"
                                />
                                <p className="text-xs text-muted-foreground mt-2">
                                    Webhook URL cho PayOS:{" "}
